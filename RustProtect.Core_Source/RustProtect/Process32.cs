namespace RustProtect
{
    ...
    public class Process32
    {
        ...
        public static bool GetProcessModules(Process process, out string[] modules)
        {
            ...
            IntPtr hProcess = Process32.OpenProcess(1040u, 0, (uint)process.Id);
            ...
            {
                int num2 = (int)((ulong)num / (ulong)((long)Marshal.SizeOf(typeof(IntPtr))));
        ...
        public static bool IsUACEnabled
        {
            get
            {
                return Registry.LocalMachine.OpenSubKey(@"Software\Microsoft\Windows\CurrentVersion\Policies\System", false).GetValue("EnableLUA").Equals(1);
            }
        }
